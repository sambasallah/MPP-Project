...
//		libraryMember.addToRecord(checkoutRecord.get(0));
		libraryMember = new LibraryMember("1002", "Drew", "Stevens", "702-998-2414", addresses.get(5));
		members.add(libraryMember);
//		libraryMember.addToRecord(checkoutRecord.get(1));
//		libraryMember.addToRecord(checkoutRecord.get(2));
...
//					BookCopy.newBookCopy(allBooks.get(0), 
//							allBooks.get(0).getCopies()[0].getCopyNum(), false)));
//			add(new CheckoutRecordEntry(LocalDate.now(),
//					LocalDate.now().plusDays(7),
//					BookCopy.newBookCopy(allBooks.get(1), 
//							allBooks.get(1).getCopies()[0].getCopyNum(), false)));
//			add(new CheckoutRecordEntry(LocalDate.now(),
//					LocalDate.now().plusDays(21),
//					BookCopy.newBookCopy(allBooks.get(2), 
//							allBooks.get(2).getCopies()[0].getCopyNum(), false)));
//		}
//	};
	
	
//	@SuppressWarnings("serial")
//	List<CheckoutRecord> checkoutRecord = new ArrayList<CheckoutRecord>() {
//		{
//		   add(new CheckoutRecord(checkoutRecordEntry.get(0)));
//		   add(new CheckoutRecord(checkoutRecordEntry.get(1)));
//		   add(new CheckoutRecord(checkoutRecordEntry.get(2)));
//		}
//	};
